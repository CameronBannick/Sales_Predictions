...
## Recomendations
If you wish to proceed deploying a model, I recommend the untuned random forest model, however the features in the dataset were very limiting in some regards. For example, there was no information regarding the brand or the actual item itself aside from the unique indicator.
